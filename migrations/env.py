...
from src.catalogue.models.database import (Product, ProductCategory, ProductDiscount, ProductImage, Category,
                                           StockRecord, RecommendedProducts, AdditionalProducts)
