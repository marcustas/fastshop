...
def get_additional_product_service(
...
def get_recommended_product_service(repo: RecommendedProductsRepository = Depends(
    get_recommended_products_repository)) -> RecommendedProductsService:
